...
if __name__ == '__main__':
    ...
    X1 = [random.random()*10+1 for i in range(100)]
    Y1 = [random.uniform(0,2)*val+random.uniform(5,20) for val in X1]
    X2 = [random.random()*10-1 for i in range(100)]
    Y2 = [random.uniform(-2,0)*val+random.uniform(-20,5) for val in X2]
    X = X1+X2
    Y = Y1+Y2
